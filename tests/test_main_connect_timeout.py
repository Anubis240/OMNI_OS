...
class DescribeDisconnectTests(unittest.TestCase):
    ...
    def test_names_the_exception_inside_the_task_group(self):
        ...
        self.assertEqual(main._describe_disconnect(err), "ConnectionError: received 1011 (internal error) keepalive ping timeout")
    ...
    def test_unwraps_nested_groups_and_caps_at_three(self):
        ...
        self.assertEqual(main._describe_disconnect(err), "ValueError: a; KeyError: 'b'; RuntimeError: c")

    def test_plain_exception_and_empty_message(self):
        self.assertEqual(main._describe_disconnect(TimeoutError()), "TimeoutError")
        self.assertEqual(main._describe_disconnect(OSError("gone")), "OSError: gone")
