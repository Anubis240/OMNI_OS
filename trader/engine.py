...
HELP_TEXT = (
    "COMMANDS &mdash; replace &lt;TICKER&gt; with your own label for the token, e.g. buy PEPE:0x...<br>"
    "buy &lt;TICKER&gt;:0xADDR &mdash; buy a token; must pass Seraph's initial risk screen<br>"
    "buy &lt;TICKER&gt;:0xADDR force &mdash; same, but skips the risk screen too (your own risk)<br>"
    "sell &lt;TICKER&gt; / close &lt;TICKER&gt; &mdash; pick how much to sell now (25/50/75/100%)<br>"
    "sell &lt;TICKER&gt; force &mdash; sell 100% immediately, skipping the gate (your own risk)<br>"
    "sell all / close all &mdash; sell every open position<br>"
    "hold &lt;TICKER&gt; &mdash; exempt a position from auto take-profit (stop-loss/max-hold still apply)<br>"
    "unhold &lt;TICKER&gt; &mdash; release a held position back to automatic control<br>"
    "take profit &lt;TICKER&gt; &mdash; pick a percentage (10/20/25/50%) to sell now, leaving the rest open<br>"
    "watch &lt;TICKER&gt;:0xADDR &mdash; add a token to the watchlist (scanned + auto-tradeable)<br>"
